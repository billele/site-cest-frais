		...
		foreach ( $this->advanced_options['button'] as $option_name => $option_settings ) {
			...
			if ( 'on' === $button_custom ) {
				...
				$main_element_styles = sprintf(
					...
					'' !== $button_border_width && 'px' !== $button_border_width ? sprintf( 'border-width:%1$s ;', et_builder_process_range_value( $button_border_width ) ) : '',
				...
				$main_element_styles_hover = sprintf(
					...
					%5$s
					%6$s',
					'' !== $button_text_color_hover ? sprintf( 'color:%1$s ;', $button_text_color_hover ) : '',
					'' !== $button_bg_color_hover ? sprintf( 'background:%1$s ;', $button_bg_color_hover ) : '',
					'' !== $button_border_color_hover ? sprintf( 'border-color:%1$s ;', $button_border_color_hover ) : '',
				...
				if ( 'off' === $button_use_icon ) {
					$main_element_styles_after = 'display:none ;';
					$no_icon_styles = 'padding: 0.3em 1em ;';
					...
					$main_element_styles_after = sprintf(
						...
						'' !== $button_icon_code ?
							...
							: '',
						'' !== $button_icon_code ? sprintf( 'font-size:%1$s ;', $button_icon_size ) : '',
					...
					if ( ( '' !== $current_text_size && '0px' !== $current_text_size ) || '' !== $current_letter_spacing ) {
						self::set_style( $function_name, array(
							...
							'declaration' => sprintf(
								'%1$s
								%2$s',
								'' !== $current_text_size && '0px' !== $current_text_size ? sprintf( 'font-size:%1$s ;', $current_text_size ) : '',
