...
class ET_Builder_Theme_Compat_evolve {
	...
	function add_styling_fix() {
		...
		$style .= '.et_builder_outer_content input[type="submit"], .et_builder_outer_content button, .et_builder_outer_content .button, .et_builder_outer_content input#submit { color: inherit ; }';
